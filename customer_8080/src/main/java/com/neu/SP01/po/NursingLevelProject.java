...
public class NursingLevelProject {
	private Integer nursingLevelProjectId;
	private Integer nursingLevelId;
	private Integer nursingProjectId;
	private Integer state;
	public Integer getNursingLevelProjectId() {
		return nursingLevelProjectId;
	}
	public void setNursingLevelProjectId(Integer nursingLevelProjectId) {
		this.nursingLevelProjectId = nursingLevelProjectId;
	}
